...
public class SessionController {
    ...
    public ResponseEntity<SessionResponse> login(
        ...
        Cookie sessionCookie = new Cookie("__Host-tpi-session", servletRequest.getSession(false).getId());
    ...
    public SessionResponse currentSession(HttpServletRequest request) {
        ...
        return email instanceof String ? new SessionResponse(true, (String) email) : new SessionResponse(false, null);
    }
